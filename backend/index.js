...
import adminDentistRouter from './routes/admin-dentist-routes.js';
...
import tempPatientsRouter from './routes/temp-patients-routes.js';
...
import { sendHelloWorldWhatsApp } from './utils/whatsapp.js';
...
app.use('/admin/dentist', adminDentistRouter);
...
app.use('/temp-patients', tempPatientsRouter);
...
app.get('/testWA', (req, res) => {
    sendHelloWorldWhatsApp('94716986818');
    res.send('WhatsApp hello_world template sent');
});
