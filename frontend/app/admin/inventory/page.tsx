            ...
            <CardContent className="p-4 lg:p-6">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xl lg:text-2xl font-semibold text-gray-900 mt-1">{loadingItemCount ? "Loading..." : itemCount}</p>
                </div>
            ...
            <CardContent className="p-4 lg:p-6">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xl lg:text-xl font-semibold text-gray-900 mt-1">{loadingInventoryValue ? "Loading..." : `Rs. ${inventoryValue}`}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-dental-dark">{loadingPurchaseOrders ? "Loading..." : purchaseOrders}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-dental-dark">{loadingEquipments ? "Loading..." : equipments}</p>
                </div>
                <div className="bg-purple-50 p-3 rounded-lg">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-semibold text-dental-dark">{loadingSuppliers ? "Loading" : suppliers}</p>
                </div>
                <div className="bg-purple-50 p-3 rounded-lg">
