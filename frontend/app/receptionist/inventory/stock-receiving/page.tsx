  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-6">
      ...
      <Dialog open={isAddOpen || isEditOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[95vw] md:max-w-2xl max-h-[90vh] flex flex-col">
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent className="sm:max-w-[95vw] md:max-w-4xl max-h-[90vh] flex flex-col p-0">
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent className="md:max-w-md">
          ...
          <AlertDialogFooter className="px-6 pb-6 pt-0 flex-col sm:flex-row gap-2">
