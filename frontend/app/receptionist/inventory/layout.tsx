...
const navigation = [
  { name: 'Dashboard', href: '/receptionist/inventory' },
  { name: 'Inventory', href: '/receptionist/inventory/inventory' },
  { name: 'Purchase Order', href: '/receptionist/inventory/purchase-order' },
  { name: 'Stock Receiving', href: '/receptionist/inventory/stock-receiving' },
  { name: 'Equipment', href: '/receptionist/inventory/equipment' },
  { name: 'Suppliers', href: '/receptionist/inventory/suppliers' },
  { name: 'Reports', href: '/receptionist/inventory/reports' },
];
