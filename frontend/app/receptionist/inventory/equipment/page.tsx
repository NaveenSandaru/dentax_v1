    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:hidden">
        <div className="grid grid-cols-1 items-center mb-4">
          <h1 className="text-2xl font-semibold text-gray-900 mb-4 ">Equipment</h1>
          <Button 
      ...
      <div className="pb-6 space-y-4">
        {/* Desktop Header */}
        <div className="hidden md:flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
          <div>
